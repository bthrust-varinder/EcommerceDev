...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('#example-daterange1').blur(function () {
            var val = $(this).val();
        ...
        $('#example-daterange2').blur(function () {
            var val = $(this).val();
        ...
        $('.input-datepicker-close').datepicker({ minDate: 2 }).on('changeDate', function (e) { $(this).datepicker('hide'); });
